                ...
                currentUser ?
                    (
                        <div className='flex items-center gap-1 my-5 text-gray-500 text-sm'>
                            <p>Signed in as:</p>
                            <img src={currentUser.avatar} alt="" className='h-5 w-5 rounded-full object-cover' />
                ...
                currentUser && (
                    <form className='border border-teal-500 rounded-md p-3' onSubmit={handleSubmit}>
                        ...
                        <div className='flex justify-between items-center mt-3'>
                            <p className='text-gray-500 text-sm'>{200 - comment.length} characters left remaining</p>
                            <Button outline gradientDuoTone='purpleToBlue' type='submit' size='sm'>Submit</Button>
                        </div>
                        {
                            commentError &&
